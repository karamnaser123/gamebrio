        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="{{ route('admin.orders') }}">
                ...
                <b class="logo-icon">
                    ...
                    <!-- Light Logo icon -->
                    <img style="width: 200px" src="{{ asset('images/logo.png') }}" alt="homepage" class="light-logo" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
                <span class="logo-text">
                    ...
                    <!-- Light Logo text -->
                    {{-- <img style="width: 200px" src="{{ asset('images/logo.png') }}" class="light-logo" alt="homepage" /> --}}
                </span>
            </a>
            <!-- ============================================================== -->
            <!-- End Logo -->
